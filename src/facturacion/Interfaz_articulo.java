...
public void limpiar()
    ...
    private void registrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registrarActionPerformed
        ...
        String[] columna= {"id_tipoarticulo"};
        index1 = (String)controlExistencias.getSentencia().GetTabla(columna, "tipo_articulo", "select id_tipoarticulo from tipo_articulo where descripcion_articulo='"+combotipo.getSelectedItem()+"';")[0][0];
        tipo = index1;
        fecha = convertTostring(calendario.getDate());
        preve = Double.parseDouble(pre_venta.getText());
        sto = Integer.parseInt(cant_prod.getText());
        
        String[] columna1 = {"No_documento"};
        index2 = (String)controlExistencias.getSentencia().GetTabla(columna, "proveedor", "select No_documento from proveedor where Nombre_comercial='"+comboproveedor.getSelectedItem()+"';")[0][0];
        prov = index2;
        
        control_articulos ctrl = new control_articulos();
        if(!des.equals(""))
         {          
        if(ctrl.ingresar_articulo(null,des,preve,sto,tipo,prov,fecha))
         {            
