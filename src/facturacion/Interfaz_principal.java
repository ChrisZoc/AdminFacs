...
control_existencias ctrl = new control_existencias();
    ...
    private void initComponents() {
        ...
        jMenuItem1.setText("Buscar personas");
        ...
        item_venta.setText("Registrar nueva factura");
        ...
        jMenuItem7.setText("Consulta facturas personas");
    ...
    private void item_ventaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_item_ventaActionPerformed
     String venta = JOptionPane.showInputDialog(this,"Ingrese el documento de la persona: ",JOptionPane.OK_OPTION);
       ...
       else
       {
          ...
          JOptionPane.showMessageDialog(null,"La persona no existe, debe registrarla","Mensaje",JOptionPane.QUESTION_MESSAGE);  
       }
