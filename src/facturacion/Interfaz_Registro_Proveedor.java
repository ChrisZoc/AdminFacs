...
control_existencias controlExistencias = new control_existencias();
    ...
    String docu,nom,ape, nom_com,dir,ciu,tipo,tel,a; 
        ...
        index1 = (String)controlExistencias.getSentencia().GetTabla(columna, "tipo_de_documento", "select id_tipo_documento from tipo_de_documento where Descripcion='RUC"+"';")[0][0];
        docu = index1;
        tipo = "RUC";
